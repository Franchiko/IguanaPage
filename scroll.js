(function () {
  ...
  var metScroll = {
    inicio: function () {
      for (let i = 0; i < propScroll.scroll_suave.length.length; i++) {
        propScroll.scroll_suave.length[i].addEventListener(
          "click",
          metScroll.moverse
        );
      }

      for (let i = 0; i < propScroll.volver_arriba.length.length; i++) {
        propScroll.volver_arriba.length[i].addEventListener(
          "click",
          metScroll.subir
        );
      }
